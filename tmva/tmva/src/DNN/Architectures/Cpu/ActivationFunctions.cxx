...
void TCpu<AFloat>::ActivationFunctionForward(Tensor_t & X, const TActivationFnctWorkspace & activationWorkspace, 
                                             const double /* coef */, const AFloat /*alpha */, const AFloat /*beta*/)
{
   // scaling and translation is not yet implemented
   TMVA::DNN::evaluate<TCpu<AFloat>>( X, activationWorkspace.activationFunction);
}
//______________________________________________________________________________
template<typename AFloat>
                                                ...
                                                const AFloat /* alpha */, const AFloat /* beta */)
{
   ...
   // compute dx = f'(x)
   TMVA::DNN::evaluateDerivative<TCpu<AFloat>>(dX, activationWorkspace.activationFunction, X); 
